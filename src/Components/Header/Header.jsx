...
const Header = () => {
  ...
  return (
    <header>
        ...
        <nav className="nav">
          ...
          <ul className="right_list desktop">
            <li className="right_item">
              <a href="#" className="right_link number_phone">
                8 (800) 555-13-26
              </a>
            </li>
            <li className="right_item">
              <a href="#" className="right_link">
                <button className="nav_btn">Заказать звонок</button>
              </a>
            </li>
          </ul>
          <button
      ...
      <div className="container">
        <div className="mob">
          <div className="stoi">Стоимость</div>
          <div>
            <h5 className="koles">
            ...
            <p className="uslugi">
              Услуги выездного шиномонтажа в СПб и ЛО для транспортных средств
            </p>
          </div>
          <div className="cars">
            <div className="narx_cars">от 199₽ </div>
            <h5 className="legkovie">Легковые автомобили</h5>
            <img src={sedan} alt="" className="sedan" />
          </div>
          <div className="carsd">
            <div className="narx_carsd">от 299₽ </div>
            <h5 className="legkovie width">Кроссоверы, джипы, минивены</h5>
            <img src={jeep} alt="" className="jeep" />
          </div>
          <div className="carsn">
            <div className="narx_carsd nnnvv">от 299₽ </div>
            <h5 className="legkovie width">Коммерческий транспорт</h5>
      ...
      <div className="menuk hide">
        ...
        <ul className="right_list_menu">
          <li className="right_item_menu">
            <a href="#" className="right_link_menu">
              8 (800) 555-13-26
            </a>
          </li>
          <li className="right_item_menu">
            <a href="#" className="right_link_menu">
              <button className="nav_btn_menu">Заказать звонок</button>
            </a>
          </li>
        </ul>
      </div>
      <div className="aside">
        <h1 className="dlya">Для юридических лиц</h1>
        <h3 className="aksiya">
          <mark>Акция!</mark> Первое авто бесплатно!
        </h3>
        ...
        <h4 className="rabota">
          Работа с НДС <br />
          Комплексное обслуживание автопарков
          <br />
          Заключение договора
          <br />
        ...
        <h6 className="vash">Ваш телефон</h6>
        <input
          type="number"
          className="inputNumbur"
          placeholder="+7 ( _ _ _ )   _ _ _    _ _    _ _"
        />
        <button className="callNumber">Оформить заявку</button>
      </div>
      <div className="tellcall hiden">
        ...
        <h1 className="tellcalltitle">МОБИЛЬНЫЙ ШИНОМОНТАЖ 24 ЧАСА В СУТКИ</h1>
        <p className="tellcalltitlebash">Ваш телефон</p>
        <input
          type="text"
          placeholder="+7 ( _ _ _ )   _ _ _    _ _    _ _"
          className="tellcalltitleinput"
        />
      </div>
    </header>
  );
